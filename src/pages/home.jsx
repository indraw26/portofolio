...
const Home = () => {
  ...
  return (
    <div className="container mx-auto flex items-center justify-center px-4 sm:px-6 min-h-screen">
      <div className="flex flex-col text-center text-white max-w-7xl w-full animate-[fadeIn_0.8s_ease-out]">
        ...
        <div className="mb-12 space-y-6 animate-[slideUp_0.6s_ease-out]">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-montserrat-bold leading-tight">
            Hi, I'm{" "}
            <span 
        ...
        <div className="space-y-6 mb-12 max-w-3xl mx-auto animate-[slideUp_0.6s_ease-out_0.2s_backwards]">
          <p className="text-base sm:text-lg md:text-xl leading-relaxed font-lato-regular text-white/80">
          ...
          <p className="text-sm sm:text-base md:text-lg leading-relaxed font-lato-regular text-white/70">
